						...
						<div class="row">		
							<div class="col-md-8 border-right">
								<div class="maincontent">	
									<div class="row">
										<?php if( $postbycat ) { foreach( $postbycat as $post ) { ?>
											<div class="col-md-12 m-top-bottom">
												<div class="post post-border-color">
													<div class="title">
														...
														<p class="post-cat">Category: <?php echo $post['name']; ?></p>
													</div> <!-- /.title -->
										...
										<?php } } else { ?>
											<div class="col-md-12 m-top-bottom">
												<div class="post">
													<p class="alert alert-danger">No Posts Available in This Category !! </p>
												</div> <!-- /.post -->
											</div> <!-- /.col-md-12 m-top-bottom -->
										<?php } ?>
									</div> <!-- /.row -->
